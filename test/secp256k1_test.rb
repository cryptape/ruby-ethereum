...
class Secp256k1Test < Minitest::Test
  ...
  def test_encode_decode_signature
    assert_equal "GwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=", Secp256k1.encode_sigature(27,0,0)
    assert_equal "HAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAM=", Secp256k1.encode_sigature(28,2,3)
